...
@section('title', 'Crear Nueva Carrera') {{-- Título específico para esta página --}}
...
@section('content')
    <div class="bg-white p-6 rounded-lg shadow-md mb-6">
        <div class="flex justify-between items-center mb-4">
            <h1 class="text-3xl font-bold text-gray-800">Crear Nueva Carrera</h1>
        ...
        <form action="{{ route('carreras.store') }}" method="POST" class="space-y-6">
            ...
            <div>
                ...
                <input type="text" id="nombre" name="nombre" value="{{ old('nombre') }}" placeholder="Ej: Ingeniería de Software" required
