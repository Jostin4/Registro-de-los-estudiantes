...
@section('title', 'Editar Estudiante') {{-- Título específico para esta página --}}
...
@section('content')
    <div class="bg-white p-6 rounded-lg shadow-md mb-6">
        <div class="flex justify-between items-center mb-4">
            <h1 class="text-3xl font-bold text-gray-800">Editar Estudiante: {{ $estudiante->nombre }} {{ $estudiante->apellido_paterno }}</h1>
        ...
        <form action="{{ route('estudiantes.update', $estudiante->id) }}" method="POST" class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="text" id="nombre" name="nombre" value="{{ old('nombre', $estudiante->nombre) }}" placeholder="Primer nombre" required
                ...
                <div>
                    ...
                    <input type="text" id="segundo_nombre" name="segundo_nombre" value="{{ old('segundo_nombre', $estudiante->segundo_nombre) }}" placeholder="Segundo nombre"
                           class="w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-indigo-500 focus:border-transparent placeholder-gray-400 text-gray-800">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="text" id="apellido_paterno" name="apellido_paterno" value="{{ old('apellido_paterno', $estudiante->apellido_paterno) }}" placeholder="Apellido Paterno" required
                           class="w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-indigo-500 focus:border-transparent placeholder-gray-400 text-gray-800">
                ...
                <div>
                    ...
                    <input type="text" id="apellido_materno" name="apellido_materno" value="{{ old('apellido_materno', $estudiante->apellido_materno) }}" placeholder="Apellido Materno" required
                           class="w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-indigo-500 focus:border-transparent placeholder-gray-400 text-gray-800">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div>
                    ...
                    <input type="email" id="correo" name="correo" value="{{ old('correo', $estudiante->correo) }}" placeholder="ejemplo@dominio.com" required
                           class="w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-indigo-500 focus:border-transparent placeholder-gray-400 text-gray-800">
                    @error('correo')
                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    @enderror
                ...
                <div>
                    ...
                    <input type="tel" id="telefono" name="telefono" value="{{ old('telefono', $estudiante->telefono) }}" placeholder="Ej: 555-123-4567"
                           class="w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-indigo-500 focus:border-transparent placeholder-gray-400 text-gray-800">
                    @error('telefono')
                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    @enderror
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div>
                    ...
                    <input type="text" id="matricula" name="matricula" value="{{ old('matricula', $estudiante->matricula) }}" placeholder="Ej: 20230001" required
                           class="w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-indigo-500 focus:border-transparent placeholder-gray-400 text-gray-800">
                    @error('matricula')
                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    @enderror
